...
HD_PWD='C:/Users/kge7/Documents/GitHub/two_fifo/two_fifo/two_fifo.runs/zynq_axisadd_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axisadd_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axisadd_0_1.tcl
