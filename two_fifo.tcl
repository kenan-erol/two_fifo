...
#
# two_fifo.tcl: Tcl script for re-creating project 'two_fifo'
#
# Generated by Vivado on Wed Aug 16 10:18:37 -0700 2023
...
#
# 1. This project restoration tcl script (two_fifo.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/kge7/Documents/GitHub/two_fifo/two_fifo/two_fifo.srcs/sources_1/bd/zynq/hdl/zynq_wrapper.v"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../../../Documents/GitHub/two_fifo/two_fifo"]"
...
set files [list \
 [file normalize "${origin_dir}/../../../../Documents/GitHub/two_fifo/two_fifo/two_fifo.srcs/sources_1/bd/zynq/hdl/zynq_wrapper.v" ]\
]
...
proc cr_bd_zynq { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_conv/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_conv/m_axi_mm2s_aclk] [get_bd_pins axi_dma_conv/m_axi_s2mm_aclk] [get_bd_pins axi_dma_conv/m_axi_sg_aclk] [get_bd_pins axi_dma_conv/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_conv/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_conv/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_conv/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_conv/S_AXI_LITE/Reg] SEG_axi_dma_conv_Reg
...
# End of cr_bd_zynq()
cr_bd_zynq ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files zynq.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files zynq.bd ] 
set_property IS_ENABLED "1" [get_files zynq.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files zynq.bd ] 
set_property IS_LOCKED "0" [get_files zynq.bd ] 
set_property IS_MANAGED "0" [get_files zynq.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files zynq.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files zynq.bd ] 
set_property PFM_NAME "" [get_files zynq.bd ] 
...
set_property USED_IN "synthesis implementation simulation" [get_files zynq.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files zynq.bd ] 
set_property USED_IN_SIMULATION "1" [get_files zynq.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files zynq.bd ] 
